...
export const MODEL_SLUG = "gpt-55"
export const MODEL_NAME = "GPT 5.5"
...
export type Gpt55ShowcaseId = keyof typeof showcaseTitles

export const showcaseIds = Object.keys(showcaseTitles) as Gpt55ShowcaseId[]

export const showcaseComponents: Record<Gpt55ShowcaseId, ComponentType> = {
...
export function isGpt55ShowcaseId(value: string): value is Gpt55ShowcaseId {
