...
export const MODEL_SLUG = "gemini-3.1-pro"
...
export type Gemini31ProShowcaseId = keyof typeof showcaseTitles

export const showcaseIds = Object.keys(showcaseTitles) as Gemini31ProShowcaseId[]

export const showcaseComponents: Record<Gemini31ProShowcaseId, ComponentType> = {
...
export function isGemini31ProShowcaseId(value: string): value is Gemini31ProShowcaseId {
